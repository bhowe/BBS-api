...
(function (blocks, i18n, element, editor, components) {
    ...
    var paypalIcon = wp.element.createElement(
        "svg",
        { xmlns: "http://www.w3.org/2000/svg", height: "20px", width: "20px", viewBox: "0 0 512.069 512.069" },
    ...
    registerBlockType('bk-block/paypal-donation-block', {
        ...
        edit: function edit(props) {
            ...
            var onChangePaypalEmail = function onChangePaypalEmail(newContent) {
                ...
                email_new_content = "[paypal_donation_block email='" + newContent + "' amount='" + userAmount + "' currency='" + userCurrency + "' size='" + userSize + "'  purpose='" + userPurpsoe + "' mode='" + userMode + "']";
            ...
            var onChangePaypalAmount = function onChangePaypalAmount(newContent) {
                ...
                amount_new_content = "[paypal_donation_block email='" + userEmail + "' amount='" + newContent + "' currency='" + userCurrency + "' size='" + userSize + " purpose='" + userPurpsoe + "' mode='" + userMode + "']";
            ...
            var onChangeCurrency = function onChangeCurrency(newContent) {
                ...
                currency_new_content = "[paypal_donation_block email='" + userEmail + "' amount='" + userAmount + "' currency='" + newContent + "' size='" + userSize + "' purpose='" + userPurpsoe + "' mode='" + userMode + "']";
            ...
            var onChangeButtonSize = function onChangeButtonSize(newContent) {
                ...
                button_new_content = "[paypal_donation_block email='" + userEmail + "' amount='" + userAmount + " currency='" + userCurrency + "' size='" + newContent + "' purpose='" + userPurpsoe + "' mode='" + userMode + "']";
            ...
            var onChangePurpose = function onChangePurpose(newContent) {
                ...
                purpose_new_content = "[paypal_donation_block email='" + userEmail + "' amount='" + userAmount + "' currency='" + userCurrency + "' size='" + userSize + "' purpose='" + newContent + "' mode='" + userMode + "']";
            ...
            var OnchangePaypalType = function OnchangePaypalType(newContent) {
                ...
                type_new_content = "[paypal_donation_block email='" + userEmail + "' amount='" + userAmount + "' currency='" + userCurrency + "' size='" + userSize + "' purpose='" + userPurpsoe + "' mode='" + newContent + "']";
            ...
            return [wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        PanelBody,
                        { title: __('Paypal Donation Block'), initialOpen: false },
                ...
                "div",
                { className: "content-wrap wp-block-shortcode" },
                wp.element.createElement(
                    "label",
                    { htmlFor: "blocks-shortcode-input-0" },
                    wp.element.createElement(
                        "svg",
                        { "aria-hidden": "true", role: "img", focusable: "false",
                            className: "dashicon dashicons-shortcode", xmlns: "http://www.w3.org/2000/svg", width: "20",
                            height: "20", viewBox: "0 0 20 20" },
                        wp.element.createElement("path", { d: "M6 14H4V6h2V4H2v12h4M7.1 17h2.1l3.7-14h-2.1M14 4v2h2v8h-2v2h4V4" })
                    ),
                    "Shortcode"
                ),
